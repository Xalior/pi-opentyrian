...
#   make card                stage the whole card, except the game data, into
#                            build/sd-card/
...
# the three kernels and the boot configuration. The Tyrian data files are not
# here and are not ours to ship — mkcard leaves tyrian/ empty and says so.

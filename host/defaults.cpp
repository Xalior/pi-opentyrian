...
//     opentyrian-defaults.ld pins to image offset 0x800. It ships with the
...
#ifdef __ELF__
__asm__ (
    "\t.section .opentyrian.entry, \"ax\", %progbits\n"
    "\t.globl _opentyrian_entry\n"
    "_opentyrian_entry:\n"
    "\tb _start\n"
    "\t.previous\n"
);
#define DEFAULTS_BLOCK_PLACEMENT \
    __attribute__ ((section (".opentyrian.defaults"), used, aligned (8)))
#else
...
TDefaultsBlock _opentyrian_defaults =
{
